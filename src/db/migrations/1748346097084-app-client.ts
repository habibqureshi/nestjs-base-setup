...
export class AppClient1748346097084 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO app_clients ( "clientId", "clientSecret", name, description) VALUES ('abc', '$2a$12$AFP5CdIB0Cq1hViCIx20quX5Sss7FfVyCyXyQgCJs7xEAuQ3gaUDy', 'Default App Client', 'Default application client for basic authentication')`,
    );
  }
